...
namespace Jobs._720pConvertor;

public class Res720pConvertorConsumer(ILogger<Res720pConvertorConsumer> logger,
                                        ...
                                        IPublishEndpoint publishEndpoint) : IConsumer<VideoPartUploaded>
{
    public async Task Consume(ConsumeContext<VideoPartUploaded> context)
    {
        ...
        string convertedPath = Path.Combine(directoryPath, "720");
