...
namespace Jobs._1080pConvertor;

public class Res1080pConvertorConsumer(ILogger<Res1080pConvertorConsumer> logger,
                                        ...
                                        IPublishEndpoint publishEndpoint) : IConsumer<VideoPartUploaded>
{
    public async Task Consume(ConsumeContext<VideoPartUploaded> context)
    {
        ...
        string convertedPath = Path.Combine(directoryPath, "1080");
