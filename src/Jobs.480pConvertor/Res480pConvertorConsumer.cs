...
namespace Jobs._480pConvertor;

public class Res480pConvertorConsumer(ILogger<Res480pConvertorConsumer> logger,
                                        ...
                                        IPublishEndpoint publishEndpoint) : IConsumer<VideoPartUploaded>
{
    public async Task Consume(ConsumeContext<VideoPartUploaded> context)
    {
        ...
        string convertedPath = Path.Combine(directoryPath, "480");
